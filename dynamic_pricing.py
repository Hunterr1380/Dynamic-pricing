...
Original file is located at
    https://colab.research.google.com/drive/15OuMz1rTCYh0cq5sMxmP0zmNbDDsOKI0
"""
...
fig = px.scatter(df,x='Expected_Ride_Duration', y='Historical_Cost_of_Ride',title='Ride_Duration Vs Cost', trendline ='ols')
fig.show()

fig= px.box(df, x='Vehicle_Type',y='Historical_Cost_of_Ride',title='Vehicle_Type Vs Cost')
fig.show()
